...
import se.miun.dt015a.search.RandomSearch;
import se.miun.dt015a.search.SearchProblem;
import se.miun.dt015a.search.Solution;
import se.miun.dt015a.search.Successor;

/**
 * A search algorithm for solving the "touring in Romania problem".
 * You should replace the search method with your implementation of the A*
 * search algorithm.
 *
...
public class TouringRomania implements InformedSearch<City,DriveAction> {
  ...
  public static void main(String[] args) {
    ...
    City goal = City.ARAD;
    TouringRomaniaProblem problem = TouringRomaniaProblem.getInstance(start, goal);

    City origin = problem.getStart();
    System.out.println("Starting in the city of " + origin);
    Set<Successor<City,DriveAction>> successors = problem.getSuccessors(origin);
